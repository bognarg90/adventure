...
public class Skeleton extends Enemy 
{
    ...
    Sound moveSound = new Sound("Entities/Skeleton/skeleton_move.mp3");
    ...
    public void render(SpriteBatch batch) 
    {
        ...
        {
            Item dropItem = new Item("Rozsdás balta", "itemSprites/tile421.png", Classifier.Weapon, 3, "Ez már nem bírja sokáig...", 3);
