...
public class InventoryOverlay 
{
    ...
    private BitmapFont nameDrawer = new BitmapFont(Gdx.files.internal("Fonts/Retron2.fnt"), Gdx.files.internal("Fonts/Retron2.png"), false);
    private BitmapFont descriptionDrawer = new BitmapFont();
    private BitmapFont dmgHealthDrawer = new BitmapFont(Gdx.files.internal("Fonts/Retron2.fnt"), Gdx.files.internal("Fonts/Retron2.png"), false);
    private BitmapFont durabilityDrawer = new BitmapFont(Gdx.files.internal("Fonts/Retron2.fnt"), Gdx.files.internal("Fonts/Retron2.png"), false);
    ...
    private BitmapFont escapeDrawer = new BitmapFont(Gdx.files.internal("Fonts/Retron2.fnt"), Gdx.files.internal("Fonts/Retron2.png"), false);
    private BitmapFont questNameDrawer = new BitmapFont(Gdx.files.internal("Fonts/Retron2.fnt"), Gdx.files.internal("Fonts/Retron2.png"), false);
    private BitmapFont questLocationDrawer = new BitmapFont(Gdx.files.internal("Fonts/Retron2.fnt"), Gdx.files.internal("Fonts/Retron2.png"), false);
    ...
    public InventoryOverlay(ArrayList<ItemStack> inventory_, Player player) 
    {
     ...
     // A küldetés részleteinek megjelenítése, szöveg mérete és pozíciója
     public void renderQuestDesc(Quest quest, SpriteBatch batch) 
     {
        ...
        escapeDrawer.draw(batch, "Nyomd meg a ESC-et a bezáráshoz", 400, 200);
        ...
        questNameDrawer.getData().setScale(1f);
        ...
        questLocationDrawer.getData().setScale(0.4f);
    ...
    public void render(SpriteBatch batch, ArrayList<ItemStack> inventory_, BitmapFont itemCounter)
    {
        ...
        try 
        {
            ...
            nameDrawer.getData().setScale(0.6f);
