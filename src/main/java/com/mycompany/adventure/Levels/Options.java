...
public class Options implements Screen
{
    ...
    public Options(Game game, boolean fromGame, GameManager ... manager) {
        ...
        musicOn.setCenter(300, 705);
        musicOff.setCenter(300, 705);
        FXOn.setCenter(300, 565);
        FXOff.setCenter(300, 565);
        VSOn.setCenter(300, 430);
        VSOff.setCenter(300, 430);
        //InvertOn.setCenter(300, 290);
        //InvertOff.setCenter(300, 290);
