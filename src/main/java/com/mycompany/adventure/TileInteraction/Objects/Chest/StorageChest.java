package com.mycompany.adventure.TileInteraction.Objects.Chest;
...
public class StorageChest extends Chest implements Json.Serializable {
    ...
    public StorageChest(float x, float y) {
        ...
        chestInventory.add(new ItemStack(new Item("Pite", "itemSprites/tile022.png", Classifier.Food, 1, "Restores 10 hearts."), 1));
